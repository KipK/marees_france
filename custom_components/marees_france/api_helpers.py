...
async def _async_fetch_and_store_coefficients(
    ...
    try:
        ...
        for monthly_coeffs_list in fetched_data_list:
            if isinstance(monthly_coeffs_list, list):
                ...
                for daily_coeffs in monthly_coeffs_list:
                    ...
                    # Ensure daily_coeffs is a list containing coefficient strings
                    # (potentially nested in single-element lists)
                    parsed_coeffs = []
                    if isinstance(daily_coeffs, list):
                        ...
                        # Only store if we successfully parsed coefficients for the day
                        if parsed_coeffs:
                    ...
                    # Increment day counter *after* processing a day's entry
        ...
        # If processed_days_count != days, log error and return False
        _LOGGER.error(
